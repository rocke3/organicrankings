...
<template>
	<p class="mt-2 mb-3 text-sm d-flex justify-content-between">
		<NuxtLink v-if="signin" class="font-weight-bold" to="/signin">
			<i class="material-icons">fingerprint</i> Sign in
		</NuxtLink>
		<NuxtLink v-if="signup" class="font-weight-bold" to="/signup">
			<i class="material-icons">person_add</i> Sign up
		</NuxtLink>
		<NuxtLink v-if="reset" class="font-weight-bold" to="/resetpassword">
