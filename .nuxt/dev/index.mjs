globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/www/organicrankings/node_modules/node-fetch-native/dist/polyfill.mjs';
...
import { parseURL, withQuery, joinURL } from 'file://C:/www/organicrankings/node_modules/ufo/dist/index.mjs';
import destr from 'file://C:/www/organicrankings/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://C:/www/organicrankings/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://C:/www/organicrankings/node_modules/ohmyfetch/dist/node.mjs';
import { createRouter as createRouter$1 } from 'file://C:/www/organicrankings/node_modules/radix3/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/www/organicrankings/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/www/organicrankings/node_modules/hookable/dist/index.mjs';
import { hash } from 'file://C:/www/organicrankings/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file://C:/www/organicrankings/node_modules/unstorage/dist/index.mjs';
import _unstorage_drivers_fs from 'file://C:/www/organicrankings/node_modules/unstorage/dist/drivers/fs.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/www/organicrankings/server/assets"}];
...
storage.mount('root', _unstorage_drivers_fs({"driver":"fs","base":"C:\\www\\organicrankings","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', _unstorage_drivers_fs({"driver":"fs","base":"C:\\www\\organicrankings\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', _unstorage_drivers_fs({"driver":"fs","base":"C:\\www\\organicrankings\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', _unstorage_drivers_fs({"driver":"fs","base":"C:\\www\\organicrankings\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const passwordresetrequst_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  'default': passwordresetrequst_post
});

const loadcaptcha = defineEventHandler((event) => {
...
const getClientManifest = () => import('file://C:/www/organicrankings/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/www/organicrankings/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
