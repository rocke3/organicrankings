  ...
  <div>
    <div class="card">
      <div class="card-header pb-0">
        <h5 class="mb-0">4 SEO Practices</h5>
        <p class="mb-0">Understand the various SEO practices that you can implement to make your website rise in the
          SERPs</p>
        <hr />
      </div>
      <div class="card-body pb-2">
          ...
          <div class="timeline timeline-one-side">
            <div class="timeline-block mb-3">
              <span class="timeline-step">
                <i class="material-icons color-primary">looks_one</i>
              </span>
              <div class="timeline-content" style="max-width: 100%;">
                ...
                <p class=" text-justify">
                  Everything you add to your website needs to be relevant to the overall theme of your website. This
                  means that all of the information you include on your website, such as content, images, H-tags,
                  keywords, blog posts, links, reviews, etc. all need to be information that ties in with what your
            ...
            <div class="timeline-block mb-3">
              <span class="timeline-step">
                <i class="material-icons color-primary">looks_two</i>
              </span>
              <div class="timeline-content" style="max-width: 100%;">
                <h6 class="mb-0">
            ...
            <div class="timeline-block mb-3">
              <span class="timeline-step">
                <i class="material-icons color-primary">looks_3</i>
              </span>
              <div class="timeline-content" style="max-width: 100%;">
                <h6 class="mb-0">
                  Understanding On-page
                </h6>
                <p class=" text-justify">
            ...
            <div class="timeline-block mb-3">
              <span class="timeline-step">
                <i class="material-icons color-primary">looks_4</i>
              </span>
              <div class="timeline-content" style="max-width: 100%;">
                <h6 class="mb-0">
                  Understanding Off-page
                </h6>
                <p class=" text-justify">
                  Off-page SEO or often called off-page optimization are the actions you take to improve your rankings
                  with links coming back to your website. Sending your off-page SEO to relevant pages will improve your
        ...
        <div>
          ...
          <p>The following pages are the step by step processes from our experience from the past 23 years. The advice
            ...
            order it has been laid out in since many of the steps require you to complete the updates from the previous
            step before moving on to the next step or your tests might be skewed. Please review each link we suggest to
            you before you use them as they can change over time. You are responsible to test each one before you use
            them on your website. If you run across any links that are inactive then there are typically many other
            services you can find on the internet to replace them if some become obsolete. If you are not sure which
            links are safe or best to use you can contact us directly at and we will be more than happy to assist you.
          </p>
          <p>
